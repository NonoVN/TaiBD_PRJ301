...
public class UniversityDAO {
    ...
    public ArrayList<UniversityDTO> filterByCollum(String collum,String value){
        ArrayList<UniversityDTO> result = new ArrayList<>();
        try {
            Connection conn = DbUtils.getConnection();
            String sql = "SELECT * FROM tblUniversity WHERE status = 1 AND " + collum + " LIKE ?";
    ...
    public ArrayList<UniversityDTO> filterByName(String name) {
        return filterByCollum("name", name);
    } 
}
